...
<head>
	...
	<center><a href="webpage.php" >Home</a></center>
</head>
<body>
    <div class="container">
		<h2 style="text-align: center;">UPLOAD FILE PHP</h2>
        <?php
		if(isset($_GET['alert'])){
		...
		?>
			<form style="text-align: center;" action="proses_act.php" method="post" enctype="multipart/form-data">			
